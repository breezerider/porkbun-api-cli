...
| dto-ux-rework | dto-migration | TypedDict→frozen dataclass migration + ttl/prio int fix + notes field + from_api boundary | easy (forced) | needs-human | plans/archived/dto-migration-build.md | 2026-09-15 (commit a65afcb; src/api.py,cli.py,utils.py · tests/test_api.py,cli.py,utils.py · docs/ristretto/manual-checks.md,memos.md) |
