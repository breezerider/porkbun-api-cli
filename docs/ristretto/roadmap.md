...
| dto-ux-rework | plan-entry-redesign | Extend Operation with Literal["match"]; emit match entries from _plan_operations | easy (forced) | done | plans/archived/plan-entry-redesign-build.md | 2026-09-15 (commit b2f7329; src/porkbun_api_cli/utils.py,cli.py · tests/test_cli.py · docs/ristretto/memos.md) |
| dto-ux-rework | cli-ux-rework | Structured plan output, exit codes, --yes, replace disabled, color, per-domain summary | normal | done | plans/archived/cli-ux-rework-build.md | 2026-09-15 (commit 929c896; README.rst · src/porkbun_api_cli/cli.py,utils.py · tests/test_cli.py,utils.py) |
| — | plan-dedup | Remove duplicate plan rendering from _plan_operations; fix ghost header in _render_plan | easy | done | plans/archived/plan-dedup-build.md | 2026-09-15 (uncommitted; src/porkbun_api_cli/cli.py · tests/test_cli.py) |
