...
| dto-ux-rework | dto-migration | TypedDict→frozen dataclass migration + ttl/prio int fix + notes field + from_api boundary | normal | planned | plans/dto-migration.md | 2026-09-14 |
